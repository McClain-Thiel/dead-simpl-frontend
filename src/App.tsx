...
type PageType = "home" | "tune" | "evaluate" | "deploy" | "profile";
...
export default function App() {
  ...
  if (currentPage === "tune") {
    return (
      <RequireAuth>
        <TunePage onBack={() => setCurrentPage("home")} />
      </RequireAuth>
    );
  }
  ...
  if (currentPage === "evaluate") {
    return (
      <RequireAuth>
        <EvaluatePage onBack={() => setCurrentPage("home")} />
      </RequireAuth>
    );
  }
  ...
  if (currentPage === "deploy") {
    return (
      <RequireAuth>
        <DeployPage onBack={() => setCurrentPage("home")} />
      </RequireAuth>
    );
  }
        ...
        <header className="border-b border-border/50 bg-background/80 backdrop-blur-sm sticky top-0 z-50">
          <div className="max-w-7xl mx-auto px-6 py-4 flex items-center justify-between">
            ...
            <div className="flex items-center gap-4">
              <Avatar className="h-8 w-8 cursor-pointer" onClick={() => setCurrentPage("profile")}>
